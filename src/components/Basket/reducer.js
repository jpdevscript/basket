...
import { 
  ...
  checkWithCheckboxIdForList } from './helper';
import { 
  ...
  mergeStateForRemoveItemFromList } from './reducerHelper';
...
const handlers = {
  ...
  [types.HANDLE_CHANGE_EVENT_FOR_ADD_INPUT_TYPES]: captureAddInputChanges,
  [types.CLICK_TRANSFER_BUTTON_FOR_LIST]: moveItemsToList,
  [types.CLICK_ADD_BUTTON_INSERT_INTO_LIST]: addItemIntoList,
  [types.CLICK_DELETE_BUTTON_FOR_ITEM]: removeItemFromList,
}
